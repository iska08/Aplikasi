...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="btn btn-success" href="{{ route("admin.pengeluaran.create") }}">
            Add Pengeluaran
        </a>
    </div>
</div>
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $pengeluaran->id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-xs btn-primary" href="{{ route('admin.pengeluaran.show', $pengeluaran->id) }}">
                                View
                            </a>
                            @endcan
                            @can('pengeluaran_edit')
                            <a class="btn btn-xs btn-info" href="{{ route('admin.pengeluaran.edit', $pengeluaran->id) }}">
                                Edit
                            </a>
                            @endcan
...
<script>
    $(function () {
        ...
        let deleteButton = {
            ...
            url: "{{ route('admin.pengeluaran.massDestroy') }}",
